...
function mostrarMensagemLogin(mensagem, tipo) {
    ...
    div.innerHTML = `<div class="mensagem ${tipo === 'success' ? 'mensagem-sucesso' : 'mensagem-erro'}">${mensagem}</div>`;
    setTimeout(() => {
        div.innerHTML = '';
    }, 3000);
}
...
// Verificar autenticação ao carregar o sistema
